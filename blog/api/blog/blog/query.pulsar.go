...
func init() {
	file_blog_blog_query_proto_init()
	md_QueryPostsRequest = File_blog_blog_query_proto.Messages().ByName("QueryPostsRequest")
}
...
func (x *fastReflection_QueryPostsRequest) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: blog.blog.QueryPostsRequest"))
		}
		panic(fmt.Errorf("message blog.blog.QueryPostsRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryPostsRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message blog.blog.QueryPostsRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryPostsRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in blog.blog.QueryPostsRequest", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	...
	fd_QueryPostsResponse_title protoreflect.FieldDescriptor
	fd_QueryPostsResponse_body  protoreflect.FieldDescriptor
)

func init() {
	file_blog_blog_query_proto_init()
	md_QueryPostsResponse = File_blog_blog_query_proto.Messages().ByName("QueryPostsResponse")
	fd_QueryPostsResponse_title = md_QueryPostsResponse.Fields().ByName("title")
	fd_QueryPostsResponse_body = md_QueryPostsResponse.Fields().ByName("body")
}
...
func (x *fastReflection_QueryPostsResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Title != "" {
		...
		if !f(fd_QueryPostsResponse_title, value) {
			return
		}
	}
	if x.Body != "" {
		value := protoreflect.ValueOfString(x.Body)
		if !f(fd_QueryPostsResponse_body, value) {
			return
		}
	}
}
...
func (x *fastReflection_QueryPostsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "blog.blog.QueryPostsResponse.title":
		return x.Title != ""
	case "blog.blog.QueryPostsResponse.body":
		return x.Body != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: blog.blog.QueryPostsResponse"))
		}
		panic(fmt.Errorf("message blog.blog.QueryPostsResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryPostsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message blog.blog.QueryPostsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryPostsResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "blog.blog.QueryPostsResponse.title":
		panic(fmt.Errorf("field title of message blog.blog.QueryPostsResponse is not mutable"))
	case "blog.blog.QueryPostsResponse.body":
		panic(fmt.Errorf("field body of message blog.blog.QueryPostsResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: blog.blog.QueryPostsResponse"))
		}
...
func (x *fastReflection_QueryPostsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in blog.blog.QueryPostsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *QueryPostsResponse) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *QueryPostsResponse) GetBody() string {
	if x != nil {
		return x.Body
	}
	return ""
...
var file_blog_blog_query_proto_rawDesc = []byte{
	...
	0x22, 0x13, 0x0a, 0x11, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x6f, 0x73, 0x74, 0x73, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x3e, 0x0a, 0x12, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x6f,
	...
	0x04, 0x62, 0x6f, 0x64, 0x79, 0x32, 0xcb, 0x01, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12,
	0x62, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x1d, 0x2e, 0x62, 0x6c, 0x6f, 0x67,
	0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x61, 0x72, 0x61, 0x6d,
	0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e,
	...
	0x12, 0x11, 0x2f, 0x62, 0x6c, 0x6f, 0x67, 0x2f, 0x62, 0x6c, 0x6f, 0x67, 0x2f, 0x70, 0x61, 0x72,
	0x61, 0x6d, 0x73, 0x12, 0x5e, 0x0a, 0x05, 0x50, 0x6f, 0x73, 0x74, 0x73, 0x12, 0x1c, 0x2e, 0x62,
	0x6c, 0x6f, 0x67, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x6f,
	0x73, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x62, 0x6c, 0x6f,
	...
	0x12, 0x12, 0x10, 0x2f, 0x62, 0x6c, 0x6f, 0x67, 0x2f, 0x62, 0x6c, 0x6f, 0x67, 0x2f, 0x70, 0x6f,
	0x73, 0x74, 0x73, 0x42, 0x7c, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e,
	0x62, 0x6c, 0x6f, 0x67, 0x42, 0x0a, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var file_blog_blog_query_proto_goTypes = []interface{}{
	...
	(*QueryPostsRequest)(nil),   // 2: blog.blog.QueryPostsRequest
	(*QueryPostsResponse)(nil),  // 3: blog.blog.QueryPostsResponse
...
var file_blog_blog_query_proto_depIdxs = []int32{
	...
	2, // 2: blog.blog.Query.Posts:input_type -> blog.blog.QueryPostsRequest
	1, // 3: blog.blog.Query.Params:output_type -> blog.blog.QueryParamsResponse
	3, // 4: blog.blog.Query.Posts:output_type -> blog.blog.QueryPostsResponse
